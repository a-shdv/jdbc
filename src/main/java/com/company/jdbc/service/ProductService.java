...
public interface ProductService {
    ...
    Optional<ProductDto> findById(UUID id); //  HttpStatus.OK (200) or HttpStatus.NOT_FOUND (404)
    Optional<ProductDto> findByUsername(String username); // HttpStatus.OK (200) or HttpStatus.NOT_FOUND (404)
